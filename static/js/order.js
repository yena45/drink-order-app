document.addEventListener('DOMContentLoaded', function () {
    ...
    const menuMap = {
        B1: {
            drinks: [
                '아메리카노', '카페 라떼','카푸치노', '플렛화이트', '바닐라빈 라떼', '헤이즐넛 라떼', '돌체 라떼',
                '바나나 라떼', '더블초콜릿 모카', '콜드브루', '콜드 브루 라떼',
                '파파야 블렌딩', '오렌지베리 블렌딩', '레몬그라스 블렌딩', '스윗루이보스 블렌딩',
                '오미자 차', '매실 차', '자몽 차', '레몬 차','청귤 차','쌍화 차', '배.도라지.대추 차',
                '패션후르츠 칸티노','제로말차 칸티노', '딸기 칸티노','딸기 요거트 칸티노', '플레인 요거트 칸티노', '망고 요거트 칸티노',
                '오미자 에이드', '매실 에이드', '자몽 에이드', '망고패션후르츠 에이드','레몬 에이드','청귤 에이드',
                '그린애플 모히또', '딸기 모히또', '초콜릿', '토피넛 라떼',
                '칸틴 밀크티', '아이스티', '딸기듬뿍 우유', '제로말차 라떼','쌍화 라떼'
            ],
            coffeeDrinks: [
                '아메리카노', '카페 라떼','카푸치노', '플렛화이트', '바닐라빈 라떼', '헤이즐넛 라떼',
        ...
        '2F': {
            drinks: [
                ...
                '초당옥수수 라떼', '쑥 라떼', '말차 라떼', '쌀 라떼','우베 라떼','벰파이어 슬레이어',

                '유자 에이드', '청귤 에이드', '유자 슬러시',
                '자몽 에이드', '플레인 요거트 스무디','꿀한라봉 슬러쉬','성주 참외 슬러쉬','팥 스무디','에스프레소 스무디'
            ],
            coffeeDrinks: [
                '에스프레소', '아메리카노', '스테이트 미엘 블랜드',
                '카페 라떼', '카푸치노', '아인슈페너',
